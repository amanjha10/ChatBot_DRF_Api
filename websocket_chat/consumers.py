...
class CompanyChatConsumer(AsyncWebsocketConsumer):
    ...
    async def handle_chat_message(self, data):
        ...
        chat_message = await self.save_chat_message(session_id, message, sender_type, sender_info)
    ...
    @database_sync_to_async
    def save_chat_message(self, session_id, message, sender_type, sender_info):
